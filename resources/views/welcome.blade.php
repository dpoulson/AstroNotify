...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark">
    ...
    <body class="antialiased dark dark:bg-black">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-black sm:items-center py-4 sm:pt-0">
            @if (Route::has('login'))
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block bg-gray-100 dark:bg-black">
                    @auth
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="row justify-content-center">
                    <div class="dark:bg-black dark:text-gray-200 space-y-4">
